...
('b1','beef','Classic Beef','經典芝士牛肉',68,
...
('b3','beef','Hottest Beef','墨辣芝士牛肉',71,
...
('v1','veggie','Mushroom Schnitzel','燕麥吉列大啡菇',61,
...
('v4','veggie','Hottest Veggie','墨辣素',67,
...
('d1a','drinks','Coke No Sugar','零系可口可樂',13,NULL,NULL,
 ...
 NULL,NULL,'["🚫🍬"]'::jsonb,NULL,false,false,false,true,20),
('d2','drinks','Cream Soda','忌廉',13,NULL,NULL,
...
('d4','drinks','Cinnamon Iced Lemon Tea','肉桂凍檸茶',22,NULL,NULL,
 '/img/menu/d4-lemon-tea.jpg',
...
('d6','drinks','Latte','鮮奶咖啡',25,NULL,NULL,
 '/img/menu/d6-latte.jpg',
 NULL,NULL,'[]'::jsonb,NULL,false,true,false,true,70),
...
('d8','drinks','Chocolate','朱古力',25,NULL,NULL,
 '/img/menu/d8-chocolate.jpg',
 NULL,NULL,'[]'::jsonb,NULL,false,true,false,true,90),
('d9','drinks','Avocado Smoothie with Oat','燕麥牛油果沙冰',37,NULL,NULL,
 '/img/menu/d9-avocado-smoothie.jpg',
 NULL,NULL,'[]'::jsonb,NULL,false,false,false,true,100),
('d10','drinks','Double Ovaltine Smoothie','雙重阿華田沙冰',40,NULL,NULL,
 '/img/menu/d10-ovaltine-smoothie.jpg',
 NULL,NULL,'[]'::jsonb,NULL,false,false,false,true,110),
...
ON CONFLICT (id) DO UPDATE SET
  ...
  -- Keep existing live price if already set (do not clobber with seed)
  price = COALESCE(public.menu_items.price, EXCLUDED.price),
  desc_en = EXCLUDED.desc_en,
  desc_zh = EXCLUDED.desc_zh,
  img = COALESCE(NULLIF(EXCLUDED.img, ''), public.menu_items.img),
  tag_en = EXCLUDED.tag_en,
  tag_zh = EXCLUDED.tag_zh,
  dietary = EXCLUDED.dietary,
  sizes = COALESCE(EXCLUDED.sizes, public.menu_items.sizes),
...
('cd2','combo_drink','Cream Soda','忌廉',0,true,30),
